...
export default function NationalIDDashboard({ ctx }: { ctx: any }) {
    ...
    <div className="admin">
      <div className="admin-nav">
        ...
        >
          ...
          <div className="nav-links">
            {['Overview','Queue','Analytics','Branches','Staff','Users','Feedback','Reports','Settings'].map(tab => (
              <div
                key={tab}
      ...
      >
        ...
        <motion.div variants={itemVariants} className="stat6">
          ...
          <motion.div whileHover={{ y: -4 }} className="stat-box"><div className="lbl">Served today</div><motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="num">3,847</motion.div><div className="trend" style={{color:'#166534'}}>+12% vs yesterday</div></motion.div>
          <motion.div whileHover={{ y: -4 }} className="stat-box"><div className="lbl">Avg wait time</div><motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="num">24 <span style={{fontSize:'16px'}}>min</span></motion.div><div className="trend" style={{color:'#d97706'}}>+3 min vs target</div></motion.div>
          <motion.div whileHover={{ y: -4 }} className="stat-box"><div className="lbl">No-show rate</div><motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="num">7.3%</motion.div><div className="trend" style={{color:'#DC2626'}}>142 missed today</div></motion.div>
          <motion.div whileHover={{ y: -4 }} className="stat-box"><div className="lbl">Satisfaction</div><motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="num">87%</motion.div><div className="trend" style={{color:'#166534'}}>+2% this week</div></motion.div>
          <motion.div whileHover={{ y: -4 }} className="stat-box"><div className="lbl">App users</div><motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="num">9,421</motion.div><div className="trend" style={{color:'#166534'}}>+622 this week</div></motion.div>
        </motion.div>
